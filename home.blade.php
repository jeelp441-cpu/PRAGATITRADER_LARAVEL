...
<div class="d-flex justify-content-center gap-3 mt-4">
    <a href="{{ route('order.product') }}" class="btn btn-soft">View Products</a>
    <a href="{{ route('my.orders') }}" class="btn btn-soft-outline">My Orders</a>
</div>
...
<p class="mt-3">{{ session('order_success') }}</p>
